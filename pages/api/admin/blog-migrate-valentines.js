...
**💝 猫咪安全情人节！** 让爱绽放，让安全常在。`;
    ...
    // 情人节博客的image_slots结构
    const imageSlots = {
      "ring_bearer": "https://images.unsplash.com/photo-1574158622682-e40e69881006?w=800&h=600&fit=crop&crop=faces",
      "flower_crown": "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=800&h=600&fit=crop&crop=faces",
      "proposal_moment": "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=800&h=600&fit=crop&crop=faces",
      "celebration_hug": "https://images.unsplash.com/photo-1596854407944-bf87f6fdd49e?w=800&h=600&fit=crop&crop=faces"
    };

    // 生成摘要
    const excerpt = "情人节猫咪安全花卉指南 - 了解哪些花卉对猫咪安全，哪些有毒，以及如何创造一个猫咪友好的情人节环境。";
    ...
    if (existingBlog) {
      ...
      return res.status(200).json({
        ...
        data: {
          blog: updateData,
          message: 'Valentine\'s Day blog updated successfully with new schema'
        }
      });
    } else {
      // 创建新博客
      ...
      return res.status(200).json({
        ...
        data: {
          blog: createData,
          message: 'Valentine\'s Day blog created successfully with new schema'
        }
      });
    }

  } catch (error) {
    console.error('🚨 Blog migration API error:', error);
    return res.status(500).json({ 
