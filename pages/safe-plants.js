...
// SafeImage component (copy from pages/index.js)
    ...
    <PageTransition>
      ...
      <div style={{ 
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          {/* Back to Home */}
          <Link href="/" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: sageGreenDark, textDecoration: 'none', marginBottom: '24px', fontWeight: 500 }}>
            ← Back to all plants
          </Link>

          {/* Header */}
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            <h1 style={{ fontSize: '48px', fontWeight: 700, color: sageGreenDark, marginBottom: '16px' }}>
              ✅ Cat-Safe Plants
            </h1>
                ...
                {searchResults.map(plant => {
                  ...
                  return (
                    <Link
                      ...
                      onMouseEnter={(e) => e.currentTarget.style.background = warmCream}
                    ...
                    >
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <span style={{ padding: '4px 12px', borderRadius: '12px', fontSize: '12px', fontWeight: 600, background: toxicity.bg, color: toxicity.color }}>
                  ...
                  onMouseLeave={(e) => {
                    ...
                    <div style={{ padding: '24px' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                        ...
                        <span style={{ padding: '6px 12px', borderRadius: '16px', fontSize: '13px', fontWeight: 600, background: toxicity.bg, color: toxicity.color, whiteSpace: 'nowrap' }}>
                          {toxicity.icon} {toxicity.label}
                        </span>
                      </div>
                      <p style={{ fontSize: '15px', color: '#5A5A5A', lineHeight: 1.6, marginBottom: '20px', minHeight: '48px' }}>
                        {plant.summary || 'Learn more about this plant.'}
                      </p>
                      <Link href={`/plants/${plant.slug}`} style={{
