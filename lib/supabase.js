...
export function createSupabaseClient() {
  ...
  const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY || HARDCODED_SERVICE_ROLE_KEY || process.env.SUPABASE_ANON_KEY;
  ...
  if (!supabaseUrl) {
    ...
    return createClient('https://rczfbgzghwiqpxihlexs.supabase.co', HARDCODED_SERVICE_ROLE_KEY);
  }
  ...
  console.log('Supabase connected - URL:', supabaseUrl.substring(0, 20) + '...');
